...
The Node.js MSI is not modified by DSH Desktop. The v0.9.1 build downloads it from the pinned official Node.js HTTPS release location and verifies the published SHA-256 plus a valid Authenticode signature before embedding it into the DSH Desktop installer.
